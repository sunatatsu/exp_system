...
const audioFileNames = [
    'audio/cntnm20251030T1422170.wav',  // (インデックス 0 = シーケンス 1)
    'audio/cntnm20251030T1422171.wav',  // (インデックス 1 = シーケンス 2)
...
// --- 6. 実験シナリオの定義 (A1) ---
// (A1のシーケンスをここで定義)
const sequence_A1 = [11, 11, 10, 10, 9, 5, 5, 4, 3, 2, 1];
...
const scenario = [
    ...
    { 
        ...
        play: (callback) => playGradationSequence(sequence_A1, sequence_interval_ms, callback) // ★A1シーケンスを再生
    },
    { 
        type: 'end', 
        message: '対話終了です。' 
...
function startExperiment() {
    ...
    console.log('実験条件 A1 (即時変化) で実験を開始');
    scenarioStep = 0;
    runScenario();
}
